...
class SpectralGraphMaxPoolingFunction(function.Function):
...
def spectral_graph_max_pooling(x, pooling_inds):
    """Graph max pooling function used by `SpectralGCNN`.
    ...
    """
    return SpectralGraphMaxPoolingFunction(pooling_inds)(x)
